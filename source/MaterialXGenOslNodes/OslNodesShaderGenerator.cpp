...
void OslNodesShaderGenerator::registerShaderMetadata(const DocumentPtr& doc, GenContext& context) const
{
...
void OslNodesShaderGenerator::emitAllDependentFunctionCalls(const ShaderNode& node, GenContext& context, ShaderStage& stage) const
{
...
void OslNodesShaderGenerator::emitLibraryIncludes(ShaderStage& stage, GenContext& context) const
{
...
void OslNodesShaderGenerator::emitShaderInputs(const VariableBlock& inputs, ShaderStage& stage) const
{
...
void OslNodesShaderGenerator::emitShaderOutputs(const VariableBlock& outputs, ShaderStage& stage) const
{
    for (size_t i = 0; i < outputs.size(); ++i)
    {
...
void OslNodesShaderGenerator::emitMetadata(const ShaderPort* port, ShaderStage& stage) const
{
